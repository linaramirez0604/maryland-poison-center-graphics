...
ggplot() + 
  ...
  theme_void() +
  labs(title="{closest_state}: Total human exposures per 10,000 individuals", fill="Rate per 10k") + theme(legend.position=c(.15,.4), legend.text.align=.5, plot.title=element_text(hjust=.15, face="bold")) + 
  coord_fixed(1.3) + 
